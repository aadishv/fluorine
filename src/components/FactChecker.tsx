      ...
      <div className="max-w-4xl mx-auto">
        {!currentRequestId && (
          <Card className="mb-8">
            <CardHeader>
              ...
              <CardDescription>
                Paste the URL of a social media post (Twitter, Facebook,
                Instagram, etc.) to fact-check its claims
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={(e) => void handleSubmit(e)} className="space-y-4">
                <div className="flex gap-2">
                  ...
                  {dailyLimit && (
                    <Badge
                      variant={dailyLimit.hasAccess ? "outline" : "destructive"}
                    >
                ...
                <div className="space-y-6">
                  ...
                  <div className="prose max-w-none">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4 border text-sm leading-relaxed">
                      <ReactMarkdown>{factCheckResult.result}</ReactMarkdown>
                    </div>
                  </div>
                </div>
              )}
        ...
        <div className="mt-8 text-center text-sm text-gray-500 max-w-2xl mx-auto">
          <p className="mb-2">
            ...
            analysis for informational purposes only. Always verify important
            information through multiple reliable sources.
          </p>
          <p>
            Results are temporary and will be cleared when you refresh the page
            or sign out.
          </p>
        </div>
      </div>
